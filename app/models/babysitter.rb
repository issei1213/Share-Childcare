...
class Babysitter < ApplicationRecord
  ...
  validates :baby_age_range_down_month, :baby_age_range_down_year, :baby_age_range_top_month, :baby_age_range_top_year, :introduction_content, :introduction_title, :money_hour, :money_option, :profile_receiving_time_down, :profile_receiving_time_top, :number_of_baby, presence: true
